...
const normalizeField = (field) => {
  ...
  if (
    Object.prototype.hasOwnProperty.call(normalizedField, 'default') &&
    typeof normalizedField.default !== 'string'
  ) {
    normalizedField.default = String(normalizedField.default);
  }

  if (Array.isArray(normalizedField.children)) {
    normalizedField.children = normalizedField.children.map(normalizeField);
  }

  return normalizedField;
};

const getCommonInputFields = () => commonInputFields.map(normalizeField);
